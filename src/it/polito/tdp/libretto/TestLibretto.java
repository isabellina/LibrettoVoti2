...
public class TestLibretto {
	...
	public static void main(String[] args) {
		...
		//main in una classe separata per accorgermi meglio della funzionalità e per evitare che gli altri vedano cose
		//potrei avere più programmi di prova
		...
		//per testare se funziona il metodo aggiungi voto 
